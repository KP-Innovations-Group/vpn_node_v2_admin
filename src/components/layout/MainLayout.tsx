    ...
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <nav className="fixed inset-x-0 bottom-0 z-30 flex items-center justify-around gap-1 overflow-x-auto border-t border-slate-200 bg-white/95 px-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/95 md:hidden">
          ...
          {role === 'super_admin' && <MobileTab to="/admins" label="Admins" icon={<svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 11a4 4 0 100-8 4 4 0 000 8zM6 19a6 6 0 0112 0v1H6v-1zM15 8l4 3-4 3" /></svg>} />}
